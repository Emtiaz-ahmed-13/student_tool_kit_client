...
export default function TextReveal() {
  const textToAnimate =
    "Don’t wait for the perfect moment. Take the moment and make it perfect. Consistent effort, even when no one is watching, is what builds greatness over time.";
